...
boolean isLoginSuccess = WebUI.verifyElementPresent(findTestObject('Login/loginSuccess'), 0, FailureHandling.OPTIONAL)
...
try {
	if (isLoginSuccess) {
		...
		assert false : 'Test failed: Element login success not found'
	}
} catch (Exception e) {
